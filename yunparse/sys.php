...
function get_api(){
	if(VOD_API == '1'){
		return get_key('AOl4Hr6Yr0VpExMpv9ARmVJbK3Dsl_eR8hfYS3gYeHkMCFRe1qfw6QWyYwPaY1v1ZxyoKXPF','D','YunParse');
	}elseif(VOD_API == '2'){
		return get_key('Bu57G7PPrRFpExMpv9ARmVJbKHDsl_eR8hfYS3gYeHkMC1Re1qfw6QWyYwPaY1v1ZxyoKX7B','D','YunParse');
	}elseif(VOD_API == '3'){
		return get_key('Duh5SrObr0JpExMpv9ARmVJbKXDsl_eR8hfYS3gYeHkMClRe1qfw6QWyYwPaY1v1ZxyoKX/E','D','YunParse');
	}elseif(VOD_API == '4'){
		return get_key('U_suT_TIrBxpExMpv9ARmVJbLnDsl_eR8hfYS3gYeHkMDVRe1qfw6QWyYwPaY1v1ZxyoLnfD','D','YunParse');
	}else{
		return get_key('VOFyTbLJqxNpExMpv9ARmVJbZCTsnvyTtlrUSTpWaWBLGRJek6O08AnyNxrTb1D1bBCiLw','D','YunParse');
	}
}
//判断防盗链域名
function is_referer(){
